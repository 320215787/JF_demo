< script type = "text/javascript" >
	...
	//	$("#mainTBDiv", self.parent.frames["mainFrame"].document).load("https://raw.githubusercontent.com/320215787/JF_demo/master/tb.html");
	//}
...
$(document).ready(function() {
   ...
   // $("#tb-menu").css({ "background-image": "url(https://raw.githubusercontent.com/320215787/JF_demo/master/tb_menu_btn.png)", "background-repeat": "no-repeat", "background-position": "center top" });
    //js
